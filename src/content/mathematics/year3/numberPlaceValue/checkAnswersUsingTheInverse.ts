    ...
    activities: <MultipleChoiceActivity[]>[
        {
            ...
            hint: "Think about which operation undoes addition. Start with the total and remove one of the numbers that was added.",
...

        {
            ...
            hint: "After subtracting, use the opposite operation to rebuild the starting number.",
...

        {
            ...
            hint: "Choose the operation that reverses what addition does.",
...

        {
            ...
            hint: "Ask yourself which operation would put back what was taken away.",
...

        {
            ...
            hint: "Begin with the total, then remove one of the original addends to see if the other appears.",
...

        {
            ...
            hint: "If the subtraction is correct, adding the answer back to the amount removed should recover the original number.",
...

        {
            ...
            hint: "Think about the operation that undoes adding.",
...

        {
            ...
            hint: "Which operation puts back what subtraction has taken away?",
...

        {
            ...
            hint: "A checking calculation starts with the total, not one of the parts.",
...

        {
            ...
            hint: "Reverse the subtraction by joining the answer and the amount that was subtracted.",
...

        {
            ...
            hint: "An addition has two addends. Removing either one from the total should leave the other.",
...

        {
            ...
            hint: "To check subtraction, combine the answer with the number that was taken away.",
...

        {
            ...
            hint: "Think about whether subtraction reverses what addition does.",
...

        {
            ...
            hint: "Adding back what was removed should return you to the starting number.",
...

        {
            ...
            hint: "Think about the purpose of doing a second calculation after solving the first one.",
...

        {
            ...
            hint: "A correct check begins with the total and uses the opposite operation.",
...

        {
            ...
            hint: "Your checking calculation should rebuild the original number from the answer.",
...

        {
            ...
            hint: "If removing one addend from the total leaves the other addend, the check is valid.",
...

        {
            ...
            hint: "See whether adding the answer to the amount removed recreates the original number.",
...

        {
            ...
            hint: "A checking calculation should undo the original addition, not repeat it by adding again.",
...

        {
            ...
            hint: "Start with the total and use the opposite operation to recover one of the numbers that was added.",
...

        {
            ...
            hint: "To check subtraction, combine the answer with the amount that was taken away.",
...

        {
            ...
            hint: "Begin with the total and remove one addend. The result should be the other addend.",
...

        {
            ...
            hint: "A correct check should rebuild the starting number from the answer and the amount removed.",
...

        {
            ...
            hint: "Think about how to undo the addition using the total as your starting point.",
...

        {
            ...
            hint: "Undo the subtraction by putting back exactly what was taken away.",
...

        {
            ...
            hint: "The second calculation should completely undo the first one and return to the original number.",
...

        {
            ...
            hint: "A subtraction check should recreate the original number using addition.",
...

        {
            ...
            hint: "A correct check starts with the total and removes one of the original parts.",
...

        {
            ...
            hint: "Think about why we use an opposite operation after solving a calculation.",
...

        {
            ...
            hint: "If subtracting one addend from the total leaves the other addend, the check is valid.",
...

        {
            ...
            hint: "Check whether the addition rebuilds the original starting number exactly.",
...

        {
            ...
            hint: "Undo the addition by starting at the total and removing one of the numbers that was added.",
...

        {
            ...
            hint: "A correct inverse check should return exactly to the original number before the subtraction.",
...

        {
            ...
            hint: "A correct check starts with the total and uses the opposite operation to recover one of the original numbers.",
...

        {
            ...
            hint: "To check subtraction, see which child rebuilds the starting number by adding.",
...

        {
            ...
            hint: "If the addition were correct, subtracting one addend from the total should return the other addend exactly.",
...

        {
            ...
            hint: "A correct inverse check should recreate the original starting number. See whether it does.",
...

        {
            ...
            hint: "Use the checking calculation first. The number you get is the same missing number in both places.",
...

        {
            ...
            hint: "The missing number must make both the subtraction and the addition true.",
...

        {
            ...
            hint: "Start with the claimed total and remove one day's sales to see if the other day's sales remain.",
...

        {
            ...
            hint: "Add together the books left and the books that were removed. The total should match the starting amount.",
...

        {
            ...
            hint: "Think about what the opposite operation helps you discover after you've finished a calculation.",
...

        {
            ...
            hint: "The second calculation should completely undo the first one and return to the starting number.",
...

        {
            ...
            hint: "In an addition, removing either original part from the total should leave the other part.",
...

        {
            ...
            hint: "The checking calculation should rebuild the original starting number.",
...

        {
            ...
            hint: "Use the total as your starting point and undo the addition by removing one addend.",
...

        {
            ...
            hint: "A correct check should return exactly to 215 by using the opposite operation.",
...

        {
            ...
            hint: "Think about which answer has evidence that it has been tested rather than simply guessed.",
...

        {
            ...
            hint: "Inverse operations aren't used to change the answer—they're used to test whether the answer is reliable.",
