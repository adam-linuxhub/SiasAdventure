    ...
    activities: <MultipleChoiceActivity[]>[
        {
            ...
            hint: "Split the number by place value: hundreds first, then tens, then ones.",
...

        {
            ...
            hint: "Look at each digit separately and convert it into hundreds, tens and ones.",
...

        {
            ...
            hint: "Combine the hundreds, tens and ones to rebuild the number.",
...

        {
            ...
            hint: "Write each digit as the value of its place instead of keeping the digits together.",
...

        {
            ...
            hint: "Read the partition from left to right: hundreds, tens, ones.",
...

        {
            ...
            hint: "The missing part comes from the middle digit of 681.",
...

        {
            ...
            hint: "The first digit tells you how many hundreds are needed.",
...

        {
            ...
            hint: "The last part of a partition is always the ones value.",
...

        {
            ...
            hint: "Each digit must keep its place value: 2 hundreds, 4 tens and 8 ones.",
...

        {
            ...
            hint: "Check whether each digit has been turned into the correct place value.",
...

        {
            ...
            hint: "Use the digits in 638 to create hundreds, tens and ones separately.",
...

        {
            ...
            hint: "The digit 5 represents five tens, not five ones.",
...

        {
            ...
            hint: "After the hundreds and tens, only the ones digit is missing.",
...

        {
            ...
            hint: "A zero in the tens place should still appear in the partition.",
...

        {
            ...
            hint: "Place the hundreds, tens and ones together in that order.",
...

        {
            ...
            hint: "The missing value comes from the middle digit, expressed as tens.",
...

        {
            ...
            hint: "Think about the value of the 8, not just the digit itself.",
...

        {
            ...
            hint: "Every digit should become its place value before adding them together.",
...

        {
            ...
            hint: "Join the hundreds, tens and ones values back into a single number.",
...

        {
            ...
            hint: "Check whether every digit has been converted into the correct place value before adding them together.",
...

        {
            ...
            hint: "The 8 is worth eight tens, not eight ones.",
...

        {
            ...
            hint: "A zero in the ones place should still appear in the partition.",
...

        {
            ...
            hint: "There are no tens in this number, so the tens part should be 0.",
...

        {
            ...
            hint: "Hundreds and tens are already shown, so only the ones value is missing.",
...

        {
            ...
            hint: "Read the partition from left to right as hundreds, tens and ones.",
...

        {
            ...
            hint: "The tens digit is always the middle digit in a three-digit number.",
...

        {
            ...
            hint: "One ten is worth 10, not 1.",
...

        {
            ...
            hint: "Combine the hundreds, tens and ones into one three-digit number.",
...

        {
            ...
            hint: "The middle digit is 0, so there are no tens to include.",
...

        {
            ...
            hint: "Start with 100, then add nine tens and finally eight ones.",
...

        {
            ...
            hint: "Each digit should be written as its place value, not simply grouped together.",
...

        {
            ...
            hint: "The first part gives the hundreds, the second gives the tens, and the last gives the ones.",
...

        {
            ...
            hint: "The missing part comes from the first digit and must be written as hundreds.",
...

        {
            ...
            hint: "Look for a number where the tens and ones have been mixed up.",
...

        {
            ...
            hint: "Write the hundreds digit first, then the tens digit, and finally the ones digit.",
...

        {
            ...
            hint: "The middle digit is 0, so the tens part contributes nothing to the total.",
...

        {
            ...
            hint: "Combine the hundreds, tens and ones without changing their order.",
...

        {
            ...
            hint: "A number ending in 0 still needs a ones part in its partition.",
...

        {
            ...
            hint: "Treat each part as a place value before putting the digits together.",
...

        {
            ...
            hint: "The final part of the partition is the ones value from the last digit.",
...

        {
            ...
            hint: "Add each partition mentally. Check whether every option totals the same number.",
...

        {
            ...
            hint: "A zero in the tens place stays in the middle of the number.",
...

        {
            ...
            hint: "Don't invent tens that aren't there—look carefully at the middle digit.",
...

        {
            ...
            hint: "The hundreds, tens and ones become the first, second and third digits.",
...

        {
            ...
            hint: "The digit 5 is in the tens place, so write its full value rather than the digit itself.",
...

        {
            ...
            hint: "Each digit should become its place value before you add the parts together.",
...

        {
            ...
            hint: "There are no tens, so the middle digit should be 0.",
...

        {
            ...
            hint: "Turn each digit into hundreds, tens and ones instead of combining digits together.",
...

        {
            ...
            hint: "The last digit should be 0 because there are no ones.",
...

        {
            ...
            hint: "One ten is worth 10, so use place values instead of the individual digits.",
