...
const romanLegacy: SkillContent = {

    skillId: "romanLegacy",

    title: "The Legacy of Roman Britain",

    description:
        "Learn about the lasting impact the Romans had on Britain, including roads, towns, language and culture.",
