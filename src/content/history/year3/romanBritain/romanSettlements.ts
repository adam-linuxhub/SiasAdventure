...
export const romanSettlements: SkillContent = {
    ...
    title: "Roman Settlements in Britain",

    description:
        "Learn how the Romans built towns, roads and forts and how settlements changed life in Britain.",
