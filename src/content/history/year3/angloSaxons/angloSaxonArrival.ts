...
export const angloSaxonArrival: SkillContent = {
    ...
    title: "The Arrival of the Anglo-Saxons",

    description:
        "Learn who the Anglo-Saxons were, where they came from and how they settled in Britain after the Romans left.",
...

    {
        ...
        options: [
            ...
            "Nothing changed",
            "The Romans returned immediately",
            "Egypt ruled Britain"
        ],
...

    {
        ...
        options: [
            ...
            "They built pyramids in Britain",
