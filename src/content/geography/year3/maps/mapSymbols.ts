...
export const mapSymbols: SkillContent = {
    ...
    description:
        "Learn how map symbols help us understand maps and find places.",
...

    {
        ...
        options: [
            ...
            "Maps never have symbols.",
            "Symbols are always words.",
...

    {
        ...
        options: [
            ...
            "Maps cannot contain words",
            "Maps are always black and white",
...

    {
        ...
        options: [
            ...
            "They are secret codes.",
            "They only appear on treasure maps.",
