...
const vocabularyInReading: SkillContent = {
    ...
    description:
        "Learn how to use clues from a text, prefixes, suffixes and word meanings to understand unfamiliar vocabulary.",
...

    {
        ...
        options: [
            ...
            "It removes all difficult words",
