...

{
    ...
    hint: "Think about the part that pushes above the ground and carries leaves towards sunlight.",
...

{
    ...
    hint: "Match each plant part with the job it is best known for.",
...
},
{
    ...
    hint: "Look for the part that grips the soil and stops the plant from falling over.",
...

{
    ...
    hint: "Think about the plant's transport pathway that connects the underground roots to the leaves.",
...

{
    ...
    hint: "The part that spreads out to collect sunlight is responsible for making food.",
...

{
    ...
    hint: "Think about which part is involved in reproduction and creating new plants.",
...

{
    ...
    hint: "A seed is the starting point of a new plant's life cycle.",
...

{
    ...
    hint: "The part touching the soil is the one that can take in water.",
...

{
    ...
    hint: "This part acts like a support pole holding the leaves in the best position for sunlight.",
...

{
    ...
    hint: "Chlorophyll is what makes many plants green and helps capture sunlight.",
...

{
    ...
    hint: "Bees visit the colourful part of a plant that helps with pollination.",
...

  {
    ...
    hint: "Think about the part of the plant that is hidden beneath the soil.",
...

{
    ...
    hint: "The stem acts like a support and a pathway connecting different parts of the plant.",
...

{
    ...
    hint: "Leaves use sunlight as part of the process that provides energy for the plant.",
...

{
    ...
    hint: "Flowers have a special role linked to creating the next generation of plants.",
...

{
    ...
    hint: "A seed is the starting point for a new plant's life cycle.",
...

{
    ...
    hint: "Start where the plant collects water and follow the path upwards.",
...
},
{
    ...
    hint: "Roots have two key jobs: collecting resources and keeping the plant secure.",
...

{
    ...
    hint: "Think about the part that holds the plant up and moves water around it.",
...

{
    ...
    hint: "Leaves are the plant's food-making parts because they capture energy from the Sun.",
...

{
    ...
    hint: "The flower's main role is connected to reproduction, not feeding or transporting water.",
...

{
    ...
    hint: "Check each plant part's job: roots, stem, leaves, flowers and seeds all have different roles.",
