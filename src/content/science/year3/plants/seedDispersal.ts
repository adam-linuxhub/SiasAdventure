...

{
    ...
    hint: "Think about what happens when seeds move from one place to another.",
...

{
    ...
    hint: "Imagine all seeds growing next to the same plant. Think about what they would compete for.",
...

{
    ...
    hint: "Look for something in nature that can move through the air.",
...

{
    ...
    hint: "Think about animals that eat fruit or move around carrying things.",
...

{
    ...
    hint: "Think about what you feel moving leaves and small objects on a windy day.",
...

{
    ...
    hint: "The seeds are moving along a river, so think about what carries them.",
...

{
    ...
    hint: "If an animal carries a seed on its body, which type of dispersal is happening?",
...

{
    ...
    hint: "Plants need resources to survive. Think about why spreading out helps.",
...

{
    ...
    hint: "Choose the natural method that can move seeds through the air.",
...

{
    ...
    hint: "The goal is to give new plants a chance to start growing.",
...

{
    ...
    hint: "Wind can move light objects more easily than heavy ones.",
...

{
    ...
    hint: "The hooks help the seed travel by attaching to something that moves.",
...

{
    ...
    hint: "Think about what happens when birds move around after eating fruit.",
...

{
    ...
    hint: "A seed carried by water needs a feature that allows it to stay on the surface.",
...

 {
    ...
    hint: "Think about what happens when too many plants try to grow in the same small area.",
...

{
    ...
    hint: "Look for the method that uses a moving liquid to carry seeds away.",
...

{
    ...
    hint: "After reaching the right place, the seed begins the first stage of becoming a plant.",
...

{
    ...
    hint: "Think about a feature that would allow a seed to attach to an animal as it walks past.",
...

{
    ...
    hint: "Choose the option that is not a natural way seeds travel from place to place.",
...

{
    ...
    hint: "Wings and hairs make seeds easier for moving air to lift and carry.",
...

{
    ...
    hint: "The seed is moving through the air, so think about what force is carrying it.",
...

{
    ...
    hint: "The seed is travelling because an animal is carrying it.",
...

{
    ...
    hint: "New plants need room to access things like sunlight, water and nutrients.",
...

{
    ...
    hint: "The seed travels across the sea, so identify what is carrying it.",
...

{
    ...
    hint: "After travelling to a new place, the seed needs to begin the growing process.",
...

{
    ...
    hint: "Seeds carried by wind need a design that helps them float or glide.",
...

{
    ...
    hint: "The fruit benefits the plant when animals take it away and move the seeds elsewhere.",
...

 {
    ...
    hint: "Think about what happens when many plants try to use the same resources in one small area.",
...

{
    ...
    hint: "Choose the method where a living creature helps move the seed.",
...

{
    ...
    hint: "Seed dispersal helps seeds reach places where they can get the things needed to survive.",
...

{
    ...
    hint: "Wind moves light objects more easily, especially seeds designed to float.",
...

{
    ...
    hint: "A seed travelling on water needs protection from becoming soaked and sinking.",
...

{
    ...
    hint: "The seed has moved because a living creature carried it.",
...

{
    ...
    hint: "Think about what moves the seed when it is floating on a river or sea.",
...

{
    ...
    hint: "Look for the answer that explains why seeds have different shapes and features.",
...

{
    ...
    hint: "The plant is next to a moving river, so think about what can carry seeds away.",
...

{
    ...
    hint: "Hooks are useful because they allow the seed to catch onto something moving.",
...

{
    ...
    hint: "Think about which method needs seeds to be light enough to move through the air.",
...

{
    ...
    hint: "Wind-dispersed seeds need features that help them glide or stay airborne.",
...

{
    ...
    hint: "Dispersed seeds have a better chance because they are not all fighting for the same resources.",
...
},
  {
    ...
    hint: "The wings change how the seed moves through the air. Think about how this helps wind carry it.",
...

{
    ...
    hint: "If an animal eats the fruit, it can help move the seeds somewhere else.",
...

{
    ...
    hint: "Think about which feature helps a seed move through air rather than stay on water.",
...

{
    ...
    hint: "Plants growing too close together must share the same resources. Think about why distance helps.",
...

{
    ...
    hint: "A seed's shape can give it a special advantage for how it travels.",
...

{
    ...
    hint: "Match each adaptation to the method where that feature would be most useful.",
...

{
    ...
    hint: "A new plant needs enough resources around it. Think about what a crowded area might limit.",
...

{
    ...
    hint: "Look for the method where seeds are carried through the air.",
...

{
    ...
    hint: "Think about why plants need to move their seeds away from themselves.",
...

{
    ...
    hint: "Choose the answer that includes both how seeds travel and why spreading them helps plants.",
