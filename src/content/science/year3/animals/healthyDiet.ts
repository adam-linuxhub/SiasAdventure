...
const healthyDiet: SkillContent = {
    ...
    activities: <MultipleChoiceActivity[]>[

        {
            ...
            hint:
                "Think about what food does for your body every day, not what it does for the world around you.",
...

        {
            ...
            hint:
                "Choose the snack that is a natural food rather than one with lots of added sugar.",
...

        {
            ...
            hint:
                "Your body needs many different nutrients, so eating just one type of food isn't enough.",
...

        {
            ...
            hint:
                "Pick the drink that keeps you hydrated without adding extra sugar.",
...

        {
            ...
            hint:
                "Only one option grows on a plant and is commonly eaten as a piece of fruit.",
...

        {
            ...
            hint:
                "No single food contains everything your body needs to grow and stay healthy.",
...

        {
            ...
            hint:
                "Look for the meal that includes foods from more than one food group.",
...

        {
            ...
            hint:
                "Choose the option that people are encouraged to eat every day, not just as a treat.",
...

        {
            ...
            hint:
                "A balanced diet is about eating a mix of foods rather than relying on just one type.",
...

        {
            ...
            hint:
                "Three statements go against healthy eating advice. Choose the one that matches what we know about staying healthy.",
    ...
    hint:
        "Think about what your body needs every day to grow, repair itself and have energy.",
...

{
    ...
    hint:
        "Look for a meal with foods from several food groups and a drink that doesn't contain added sugar.",
...

{
    ...
    hint:
        "Choose the food that is usually high in added sugar and is considered an occasional treat.",
...

{
    ...
    hint:
        "Only one option is a green plant that is commonly served alongside a main meal.",
...

{
    ...
    hint:
        "Your body loses water throughout the day, so think about what drinking water replaces.",
...

{
    ...
    hint:
        "Healthy habits help your body get different nutrients regularly instead of missing them.",
...

{
    ...
    hint:
        "A balanced meal usually contains more than one type of food, not just one snack food.",
...

{
    ...
    hint:
        "Think about which answer explains healthy eating rather than making an unrelated claim about sugar.",
...

{
    ...
    hint:
        "Your body needs many different nutrients, so avoid answers that rely on just one type of food.",
...

{
    ...
    hint:
        "The best summary should mention both eating a range of foods and making healthy drink choices.",
