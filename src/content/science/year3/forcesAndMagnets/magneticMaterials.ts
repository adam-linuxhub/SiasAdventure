...

{
    ...
    hint:
        "Think about what happens when you hold a magnet near certain metal objects like paper clips.",
...

{
    ...
    hint:
        "Only one option is a metal that magnets are well known for attracting.",
...

{
    ...
    hint:
        "Look for the object made from a magnetic metal rather than wood, plastic or rubber.",
...

{
    ...
    hint:
        "Three choices are metals that magnets can attract. Find the everyday material that isn't a metal.",
...

{
    ...
    hint:
        "Think about which metal is commonly used to make paper clips and many screws.",
...

{
    ...
    hint:
        "Choose the object that is usually made from steel instead of rubber, wood or plastic.",
...

{
    ...
    hint:
        "Only one option is a metal that can be pulled by a magnet.",
...

{
    ...
    hint:
        "Ask yourself whether wood is a metal or a non-metal material.",
...

{
    ...
    hint:
        "Three objects contain magnetic metals. One is made from a material magnets do not attract.",
...

{
    ...
    hint:
        "Think about metals like gold, aluminium and copper—they don't all behave the same around magnets.",
...
},
{
    ...
    hint:
        "Think about the metal most commonly used to show how magnets work in science lessons.",
...

{
    ...
    hint:
        "Magnets are attracted by the material an object is made from, not its weight or texture.",
...

{
    ...
    hint:
        "To discover if something is magnetic, you need to observe how it behaves around a magnet.",
...

{
    ...
    hint:
        "Look for the pair made from metals that magnets commonly attract.",
...

{
    ...
    hint:
        "A magnet doesn't care about size or age—it only reacts to certain materials.",
...

{
    ...
    hint:
        "Fridge doors are made from a material that magnets can cling to. Choose the matching material.",
...

{
    ...
    hint:
        "The deciding factor is what the object is made from, not its size or weight.",
...

{
    ...
    hint:
        "Choose an object made from a magnetic metal so the result is easy to observe.",
...

{
    ...
    hint:
        "Three choices are magnetic metals. Pick the material that magnets cannot attract.",
...

{
    ...
    hint:
        "Think about the definition of a magnetic material rather than what a magnet can or cannot do.",
